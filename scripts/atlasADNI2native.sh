#!/bin/bash
#
# This code warps an atlas from ADNI normal template space to the subjects native space.
#
# Usage: atlas2native.sh 14_w 14_w_preop.nii.gz atlas2template_AAL116_origin_MNI_T1.nii
#
#
# Thomas Campbell Arnold 
# tcarnold@seas.upenn.edu
#
# Currently not finding mask during registration step (last line)
#
# 5/17/2019 - created
# 6/5/2019 - seperated into atlas2NickOasis.sh and atlas2native.sh
# 10/3/2019 - adapted for ANDI template and renamed
...
# Registration of ADNI Template to Single Subject Template (SST)
antsRegistration \
--dimensionality 3 \
--float 0 \
